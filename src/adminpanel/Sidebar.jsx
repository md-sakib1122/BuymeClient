...
function Sidebar({ sidebar, setSidebar }) {
   ...
   const showBar = ' absolute text-slate-700 row-span-2 bg-white  left-0 right-1/2 bottom-0 top-0 transition-all '
  ...
  return (
    <div className = {sidebar? hideBar : showBar}>
        <div className=' w-full flex justify-between items-center px-4 mb-10 mt-4'>
            ...
            <div className=' lg:hidden visible' onClick={()=>setSidebar(true)}>
             <ImCross />
            </div>
        </div>
